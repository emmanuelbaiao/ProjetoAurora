...
router.get('/funcionario/user=:id&func=:idFunc',checarFuncionario, DependentesController.visualizarDependentes)
//Rota para editar os dependentes na view de funcionários
router.get('/funcionario/edit/dep=:id',checarFuncionario, DependentesController.funcionarioEditarDependentes);
//Rota para salvar a edição dos dependentes na view de funcionários
router.post('/funcionario/edit/:id/save',checarFuncionario, DependentesController.funcionarioSalvarDependentes);
//Rota para excluir os dependentes na view de funcionários
router.get('/funcionario/delete/:id',checarFuncionario, DependentesController.funcionarioExcluirDependentes);
