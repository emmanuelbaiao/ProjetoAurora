...
module.exports = class MenuController {
  static async renderizarMenuFuncionario(req, res) {
    ...
    const perfil = await Perfil.findOne({raw: true, where: {id: usuario.PerfiId}});
  ...
  static async renderizarMenuAssociado(req, res) {
    ...
    res.render("associado/menu-associado", { usuario, perfil, associadoStatus });
  }
  ...
  static async visualizarConta(req, res) {
    ...
    res.render("associado/visualizar-conta", { usuario, associado, associadoStatus});
  }
...
const idFunc = req.session.userId;
  ...
  static async visualizarHistorico (req, res) {
    ...
    res.render('funcionario/historico', { listaAlteracoes, funcionario, idFunc });
  ...
  static async visualizarReservasFuncionario(req, res){
   ...
   const associado = await Associado.findOne({raw: true, where: {UsuarioId: id}})
    ...
    if (await Funcionario.findOne({where: {UsuarioId: id}})) {
      ...
      res.render("associado/reservas", { listaReservas, listaAreas, associado, usuario});
